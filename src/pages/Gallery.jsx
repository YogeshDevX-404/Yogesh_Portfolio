...
const IMAGES = {
  ...
  id: 1,
  caption:
    "🚀 AI Career Coach – A smart platform that helps users build resumes, generate AI cover letters, and prepare for interviews with personalized career insights.",
  photos: ["/gallery/inteli.png", "/gallery/inteli1.png", "/gallery/inteli2.png", "/gallery/inteli3.png"],
  },
    
  {
  id: 3,
  caption:
    "💻 Realtime Code Editor – A collaborative coding platform where multiple users can write and edit code simultaneously with real-time synchronization.",
  photos: ["/gallery/code1.png", "/gallery/code2.png"],
},
  ...
  achievements: [
    {
      id: 1,
      caption: "Solved 1000+ LeetCode questions in future🏆!",
      photos: ["/gallery/leetcode.png"],
    },
    {
      id: 2,
      caption: "Technical Lead at AIMT Enigma Club 🤖",
    ...
    {
      id: 1,
      caption: "College by day, developer by passion. 🚀",
      photos: ["/gallery/tl.jpg", "/gallery/yogesh.jpg"],
    },
    {
      id: 2,
      caption:
        "Exploring a new state to refresh my mind 🌄 Inspiration hits differently on the road.",
      photos: ["/gallery/yp.jpg", "/gallery/yogu.jpg"],
    },
  ],
};

...
const SKILLS = [
  ...
  { name: "GitHub Actions (CI/CD)", logo: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/githubactions/githubactions-original.svg" },

  // AI / ML (Basic from your previous projects)
...
const ROWS = [
  [
    ...
    { title: "Frontend Technologies", items: ["HTML", "CSS", "JavaScript", "TailwindCSS"] },
    { title: "Backend Technologies", items: ["Node.js", "Express"] },
